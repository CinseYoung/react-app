module.exports = {
	...
	"rules": {
		...
		"no-use-before-define": [1, { functions: false, classes: true, variables: true }], //未定义前不能使用
		"camelcase": 0, //强制驼峰法命名
		"jsx-quotes": [0, "prefer-single"], //强制在JSX属性（jsx-quotes）中一致使用双引号
		...
		"react/jsx-indent-props": [0, "tab"], //验证JSX中的props缩进
